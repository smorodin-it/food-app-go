...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/responses.ResponseApi-array_handlers_TestDomain"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.TestForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/test_handler/filter/{firstId}/{secondId}/{thirdId}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.FilterForm"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/responses.ResponseApi-array_string"
                        }
                    }
                }
            }
        },
        "/test_handler/{firstId}/{secondId}": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/test_handler/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/responses.ResponseApi-handlers_TestDomain"
                        }
                    }
                }
            },
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ingredient in test id",
                        "name": "request",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "responses.ResponseApi-array_handlers_TestDomain": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.TestDomain"
                    }
                },
                "error": {
                    "type": "string"
        ...
        "responses.ResponseApi-array_string": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "responses.ResponseApi-handlers_TestDomain": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/handlers.TestDomain"
